...
export const PostModal = ({
  ...
  const [isLiking, setIsLiking] = useState(singlePost.liked_by_user || false);
      ...
      <style>
        {`
          ...
          .carousel .control-prev.control-arrow:hover {
              background-color: black;  /* Mantener fondo negro al pasar el ratón */
              opacity: 1;
          }

        `}
      </style>
      <div className="flex flex-col w-full items-center justify-center p-10 pt-0 ">
        <div className="flex w-full justify-between items-center bg-gray-300 border-black border-[3px] border-b-[0px] p-3 rounded-t-lg">
          <div className="flex items-center gap-1 bg-black py-1 px-4 rounded-lg  ">
            <span className="text-lg text-white font-[700]">
              {singlePost.likes}
            </span>
            <svg
              width="25px"
        ...
        <div className="grid grid-cols-3 w-full border-black border-[3px]">
          <Carousel
              ...
              >
                <div className="h-[40em] h-full">
                  <img
                    ...
                    src={`${env.SERVER_S3}/media/${photo.imagen}`}
                    alt={`Photo ${index}`}
                  />
                </div>
              </div>
          ...
          <div className="flex flex-col justify-end border-l-[3px] border-black w-full bg-white bg-opacity-50 overflow-hidden">
            ...
            <div className="w-full flex  border-t-[3px] border-black bg-gray-100">
              <div className="text-[18px] font-[400] w-full py-4 px-2 ">
                <a
                ...
                {singlePost.descripcion.length === 0 ? ' ...' : singlePost.descripcion}
              </div>
              <div className="flex ">
                {logged ? (
